...
namespace CapaDatos
{
    public class CD_CompraMateriales
    {
        ...
        public Compra ObtenerCompra(string numero)
        {
            ...
            using (SqlConnection oconexion = new SqlConnection(Conexion.cadena))
            {
                ...
                try
                {
                    ...
                    query.AppendLine("pr.Documento,pr.Tipo_Proveedor,");
                    ...
                    using (SqlDataReader dr = cmd.ExecuteReader())
                    {
                        while (dr.Read())
                        {
                            obj = new Compra()
                            {
                                ...
                                oProveedor = new Proveedor() { Documento = dr["Documento"].ToString(), Tipo_Proveedor = dr["Tipo_Proveedor"].ToString() },
