...
namespace CapaPresentacion
{
    public partial class frmCompra : Form
    {
        ...
        private void btnagregarproducto_Click(object sender, EventArgs e)
        {
            ...
            //if (txtpreciocompra.Text == "0,00" || txtprecioventa.Text == "0,00")
            //{
            //    MessageBox.Show("Precio Compra sin precio establecido", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            //    txtpreciocompra.Select();
            //}

            if (!decimal.TryParse(txtpreciocompra.Text, out preciocompra))
            {
                MessageBox.Show("Precio Compra - campo vacio no permitido", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                txtpreciocompra.Select();
                return;
            }

            //if (txtprecioventa.Text == "0,00" || txtprecioventa.Text == "0,00")
            //{
            //    MessageBox.Show("Precio Venta sin precio establecido", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            //    txtpreciocompra.Select();
            //}
            ...
            {
                MessageBox.Show("Precio Venta - campo vacio no permitido", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            ...
            //if (!producto_existe && txtpreciocompra.Text != "0,00" && txtprecioventa.Text != "0,00")
            //{
