...
{
    public partial class mdTipoObra : Form
    {
        ...
        private void mdTipoObra_Load(object sender, EventArgs e)
        {
            ...
            {
                if(item.DescripcionTipo == "No Contempla" || item.DescripcionTipo == "no contempla" || item.DescripcionTipo == "NO CONTEMPLA")
                {
                    continue;
                }
